SELECT DISTINCT 
    ...
    ,CASE 
        ...
        WHEN genres LIKE '%reggaeton%' OR genres LIKE '%urbano%' THEN 'Reggaeton'--2
        WHEN genres LIKE '%hip hop%' OR genres LIKE '%rap%' OR genres LIKE '%trap%' THEN 'Hip-Hop/Rap'--3
        ...
        WHEN genres LIKE '%opm%' OR genres LIKE '%afropop%' OR genres LIKE '%latino%' THEN 'World/Regional'--9
        ...
        WHEN genres LIKE '%pop%' OR genres LIKE '%dance pop%' THEN 'Pop'--13
